...
class Atom:
    ...
    def read_pdb_line(self, line):
        ...
        if self.residue_name.strip() == "":
            self.residue_name = " MOL"
                ...
                if (
                    ...
                    if (
                        ...
                        key = (
                            ...
                            + "_"
                            + str(temp_atom.res_id)
                            + "_"
                            + temp_atom.residue_name.strip()
                            + "_"
                            + temp_atom.chain_id.strip()
                        )  # this string unique identifies each atom

                        if (
                            not key in atom_already_loaded
                            or not temp_atom.residue_name.strip()
                            in self.protein_resnames
                        ):  # so either the atom hasn't been loaded, or else it's a non-protein atom
